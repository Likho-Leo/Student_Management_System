...
Data Access Layer: ADO.NET for database connectivity

Database Layer: SQL Server with relational tables
...
Configure the SQL Server connection string in the project.

Ensure the required database and tables are created.
